...
class CLS_Add_New_Client_Screen : protected CLS_Header_Screen
{
private:
...
public:
    ...
    {
        if (!Check_Access_Rights(CLS_Bank_User::EN_Permissions::Add_New_Client))
        {
            return;
        }
        ...
        {
            cout << "This Account Number Already Exists ,Choose Another Number: ";
            Account_Number = clsInputValidate::ReadString();
        }
        CLS_Bank_Client New_Client = CLS_Bank_Client::Add_New_Object(Account_Number);
        ...
        case CLS_Bank_Client::EN_Save_Results::Failed_Account_Number_Exist:
        {
